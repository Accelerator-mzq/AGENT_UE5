...
测试体系按"语义层 + 执行后端"两维划分,共 17 类 359 条用例(`Plugins/AgentBridge/Tests/SystemTestCases.md` §1)。
...
**系统测试套件**(F-TST-04):`run_system_tests.py` 注册 13 个 Stage 共 359 条用例,分 17 类 (SV/BL/Q/W/CL/UI/CMD/PY/ORC/CP/SS/GA/E2E/MCP/P11/LIR/SKS)。证据落盘到 `ProjectState/Reports/YYYY-MM-DD/` + `ProjectState/Evidence/`,历史归档复制到 `Docs/History/reports/AgentBridgeEvidence/`(`Docs/requirements/SRS.md#6.3`)。
