...
| 文件 | 分类 | 作用 |
|------|------|------|
| `Docs/Current/14_MCP_Cognitive_Bridge_Anchor.md` | 一级治理 | MCP 总口径声明，所有 MCP 文档的优先裁决依据 |
| `Docs/Current/15_Skill_Spec_Handoff_Chain.md` | 一级治理 | Skill/Spec/Handoff 四层主链定义，含流程图和边界声明 |
| `Docs/Current/16_MCP_Repositioning_Plan.md` | 一级治理 | MCP 重定位完整方案，含架构图、Monopoly 示例、验收标准 |
| `Docs/Proposals/Phase10_Compiler_Capability_Bus_v3.md` | 二级提案 | 前端认知分解接口定义（Stage 1-2 的 MCP 工具） |
| `Docs/Proposals/Phase10_Execution_MCP_Adapter_v3.md` | 二级提案 | 执行层 MCP Adapter 边界说明 |
| `Docs/Proposals/Phase10_Validation_Testing_Plane_v3.md` | 二级提案 | 测试 MCP 角色定义（Evidence Judge） |
| `Docs/Proposals/Phase10_MCP_Testing_Toolset_v2.md` | 二级提案 | 测试工具集最小实现说明 |
...
| `Docs/Current/00_Index.md` | 阶段名改 Phase 10 准备；文件表加入 14/15/16；事实来源更新 |
| `Plugins/AgentBridge/README.md` | 加入 MCP 重定位注释和参考链接 |
| `Plugins/AgentBridge/AGENTS.md` | 框架组件列表加入"MCP 认知桥接层" |
| `Plugins/AgentBridge/Docs/architecture_overview.md` | 版本升 v0.9.0；§1.1/§2/§5.3/§9 四处架构图全部更新 |
| `Plugins/AgentBridge/Docs/compiler_design.md` | 版本升 v0.9.0；MCP 描述从"执行通道"改为"认知桥接层" |
| `Plugins/AgentBridge/Docs/skills_and_specs_overview.md` | 版本升 v0.9.0；加入四层标准表述和 Dynamic Spec 约束说明 |
...
3. `Docs/Current/00_Index.md` — 当前阶段索引
4. **`Docs/Current/14_MCP_Cognitive_Bridge_Anchor.md`** — MCP 总口径，优先裁决依据
5. **`Docs/Current/15_Skill_Spec_Handoff_Chain.md`** — 四层主链定义
6. **`Docs/Current/16_MCP_Repositioning_Plan.md`** — 完整重定位方案，§11 列出待实现事项

### 2.2 执行参考

7. `Docs/Proposals/Phase10_Compiler_Capability_Bus_v3.md` — Stage 1-2 MCP 工具的接口设计
8. `Docs/Proposals/Phase10_Execution_MCP_Adapter_v3.md` — 执行适配层边界
9. `Docs/Proposals/Phase10_Validation_Testing_Plane_v3.md` — 测试裁决层角色
10. `Docs/Proposals/Phase10_MCP_Testing_Toolset_v2.md` — 测试工具集最小实现

### 2.3 现有实现参考

11. `Plugins/AgentBridge/Docs/architecture_overview.md` — 已更新的架构全图
12. `Plugins/AgentBridge/Docs/compiler_design.md` — 编译器设计文档
13. `Plugins/AgentBridge/Docs/skills_and_specs_overview.md` — Skill/Spec 体系说明
...
以下事项在治理文档中已定义清楚，但需要你在执行阶段落地。详见 `Docs/Current/16_MCP_Repositioning_Plan.md` §11。
...
- **缺少**：Stage 间产物传递规范
- 接口设计参考：`Docs/Proposals/Phase10_Compiler_Capability_Bus_v3.md`
...
- **缺少**：证据存放目录结构标准化
- **缺少**：证据索引 manifest
- 角色定义参考：`Docs/Proposals/Phase10_Validation_Testing_Plane_v3.md`
