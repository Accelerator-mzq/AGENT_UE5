...
| `Plugins/AgentBridge/Docs/universal_baseline_standard.md` | Universal Baseline 标准 | design/HLD.md#2.1 + requirements/SRS.md#3 + design/LLD/06_skills_and_templates.md | already-consumed |
