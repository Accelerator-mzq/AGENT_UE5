# AGENT_UE5 Universal Game Baseline Standard
> 原始来源：Docs/History/Phase11_Design_Pack/03_Universal_Baseline_Standard.md
...
详见 `04_Baseline_Realization_Policy.md`。
...
- **Start Screen（入口壳层）**
  ...
  - 可选实现：主菜单前态 / Frontend Shell 前置状态
...
升级判断发生在：
- Root Skill Contract 形成时（初始标注）
- Clarification Gate 之后（如回答揭示了设计需求）
