...
- Phase 8 历史任务正文已明确写出 HUD、Popup、5 个 WBP 和绑定要求，见 [task8_phase8.md:942](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Tasks/task8_phase8.md:942) 和 [task8_phase8.md:967](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Tasks/task8_phase8.md:967)。
...
交接文档明确建议“全部在 `NativeConstruct()` 中构建控件树”，见 [Phase8_M3_Handover_to_Execution_Agent.md:452](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Proposals/Phase8_M3_Handover_to_Execution_Agent.md:452) 到 [Phase8_M3_Handover_to_Execution_Agent.md:471](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Proposals/Phase8_M3_Handover_to_Execution_Agent.md:471)。Phase 8 历史任务也沿用了同样口径，见 [task8_phase8.md:952](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Tasks/task8_phase8.md:952)。
...
- `val-11` 只要求 `HUDWidget != nullptr, PopupWidget 可 CreateWidget`，见 [task8_phase8.md:975](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Tasks/task8_phase8.md:975) 和 [task8_phase8.md:997](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Tasks/task8_phase8.md:997)。
- 这里没有检查 HUD 是否真实显示在视口里，也没有检查按钮是否真的能点。

M4 的主回归又主要依赖 `--no-editor` 与 simulated 流程。

- 系统测试主入口是 `python Plugins/AgentBridge/Tests/run_system_tests.py --no-editor`，见 [task8_phase8.md:1065](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Tasks/task8_phase8.md:1065)。
- 兼容性验证仍保留 simulated demo 旧链路，而不是只靠编辑器内真实 Play，见 [task8_phase8.md:1075](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Tasks/task8_phase8.md:1075) 和 [task8_phase8.md:1148](/D:/UnrealProjects/Mvpv4TestCodex/Docs/History/Tasks/task8_phase8.md:1148)。
...
4. Phase 8 late validation 期间不切换 MCP，Phase 9 再切换并补验证，这个执行顺序属于阶段治理约束，不应跳过。
