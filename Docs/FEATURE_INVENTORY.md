...
> 状态: 骨架 v1,主文档锚点 + UE 5.7 状态待 Phase 1 / Phase 1.18 回填
...
| F-CPP-06 | FAgentBridgeModule | IModuleInterface 实现,模块加载/卸载钩子 | C++ | TBD | Plugins/AgentBridge/Source/AgentBridge/Private/AgentBridgeModule.cpp | TBD | TBD |
...
| F-BRG-03 | L1 反馈接口族 | 7 接口对应 feedback Schema 系列(actor/asset/level/project/validation) | Bridge | TBD | Plugins/AgentBridge/Scripts/bridge/{query_tools,write_tools}.py + Schemas/feedback/* | TBD | TBD |
...
| F-CMP-09 | Stage — clarification_gate | Stage 2 澄清门(用户确认必填项) | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/clarification_gate.py | TBD | TBD |
| F-CMP-10 | Stage — skill_graph_planning | Stage 3 SkillGraph 规划 | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/skill_graph_planning.py | TBD | TBD |
| F-CMP-11 | Stage — discovery_fallback | Stage 4 路 A:Design Space Discovery 回退 | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/discovery_fallback.py | TBD | TBD |
| F-CMP-12 | Stage — realization_fallback | Stage 4 路 B:Realization 回退 | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/realization_fallback.py | TBD | TBD |
| F-CMP-13 | Stage — convergence_fallback | Stage 4 路 C:Convergence 回退 | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/convergence_fallback.py | TBD | TBD |
| F-CMP-14 | Stage — agent_protocol | LLM Agent 协议封装 | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/agent_protocol.py | TBD | TBD |
| F-CMP-15 | Stage — llm_client | LLM 客户端(OpenAI/Claude 等 provider 抽象) | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/llm_client.py | TBD | TBD |
| F-CMP-16 | Stage — handoff_v3 | reviewed_handoff v3 生成 Stage | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/handoff_v3.py | TBD | TBD |
| F-CMP-17 | Stage — cross_review_v2 | 跨审 v2 Stage | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/cross_review_v2.py | TBD | TBD |
| F-CMP-18 | Stage — lowering_v2 | Build IR v2 下降 Stage | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/lowering_v2.py | TBD | TBD |
| F-CMP-19 | Stage — domain_skill_runtime | Domain Skill 运行时承载 Stage | Compiler | TBD | Plugins/AgentBridge/Compiler/stages/domain_skill_runtime.py | TBD | TBD |
| F-CMP-20 | Framework — cross_review | 跨审框架组件(v2 实现支撑) | Compiler | TBD | Plugins/AgentBridge/Compiler/cross_review/ | TBD | TBD |
| F-CMP-21 | Framework — intake | Phase 11 intake 框架组件 | Compiler | TBD | Plugins/AgentBridge/Compiler/intake/ | TBD | TBD |
| F-CMP-22 | Framework — lowering | Phase 11 lowering 框架组件 | Compiler | TBD | Plugins/AgentBridge/Compiler/lowering/ | TBD | TBD |
| F-CMP-23 | Framework — planner | Phase 11 planner 框架组件 | Compiler | TBD | Plugins/AgentBridge/Compiler/planner/ | TBD | TBD |
| F-CMP-24 | Framework — skill_runtime | Phase 11 skill_runtime 框架组件 | Compiler | TBD | Plugins/AgentBridge/Compiler/skill_runtime/ | TBD | TBD |
...
| F-RT-01 | UE 关卡引导(Editor game) | Editor 模式下关卡启动+引导流程 | Runtime | TBD | Plugins/AgentBridge/Scripts/orchestrator/orchestrator.py(editor 通道) | TBD | TBD |
| F-RT-02 | Standalone staged 运行时 | 打包后 Standalone staged 模式运行时 | Runtime | TBD | Plugins/AgentBridge/Scripts/orchestrator/orchestrator.py(standalone 通道) + Source/AgentBridge/Private/UATRunner.cpp | TBD | TBD |
...
| F-CHN-MODE-03 | 模式路由 — Playable Runtime | 可运行运行时模式路由 | Chain | TBD | Plugins/AgentBridge/Scripts/orchestrator/orchestrator.py(runtime 通道) | TBD | TBD |
...
| F-GOV-03 | generator_provider 影响 is_promotable | generator_provider 字段决定 is_promotable 的治理规则 | Governance | TBD | Plugins/AgentBridge/MCP/compiler_tools.py + Schemas/compiler_session.schema.json | TBD | TBD |
| F-GOV-04 | compare/promote 工具 | Run 比较与晋升 MCP 工具入口 | Governance | TBD | Plugins/AgentBridge/MCP/compiler_tools.py + Schemas/run_comparison.schema.json | TBD | TBD |
| F-SCH-01 | 主链 v3 Schema 集 | root_skill_contract / skill_graph / design_space_report / realization_candidates / converged_realization_pack / clarification_gate_report / cross_review_report_v2 / build_ir_v2 / reviewed_handoff_v3 | Schema | TBD | Plugins/AgentBridge/Schemas/{root_skill_contract,skill_graph,design_space_report,realization_candidates,converged_realization_pack,clarification_gate_report,cross_review_report_v2,build_ir_v2,reviewed_handoff_v3}.schema.json | TBD | TBD |
| F-SCH-02 | v1/v2 兼容 Schema | reviewed_handoff v1/v2 + build_ir v1 + cross_review_report v1 + skill_fragment v1/v2 兼容契约 | Schema | TBD | Plugins/AgentBridge/Schemas/{reviewed_handoff,reviewed_handoff_v2,build_ir,cross_review_report,skill_fragment,skill_fragment_v2}.schema.json | TBD | TBD |
...
| F-SCH-05 | 治理 Schema | compiler_session / naming_resolution_log / design_decision_log / run_comparison / batch_manifest / evidence_manifest | Schema | TBD | Plugins/AgentBridge/Schemas/{compiler_session,naming_resolution_log,design_decision_log,run_comparison,batch_manifest,evidence_manifest}.schema.json | TBD | TBD |
| F-SCH-06 | Examples 与版本清单 | examples/ 样例 + versions/ 版本清单 + 早期辅助 schema(gdd_projection / planner_output / run_plan) | Schema | TBD | Plugins/AgentBridge/Schemas/examples/ + versions/ + Schemas/{gdd_projection,planner_output,run_plan}.schema.json | TBD | TBD |

## 验收门禁(摘自关联 spec v1.1 §3.2 / §8)

| 证据源 | 数量 | 细粒度门禁 |
|--------|------|------------|
| 代码公开符号 | Phase 1 grep 统计 | 每符号 ≥ 1 F-* 或 catalog 行引用 |
